...
# @flask_app.route("/livpredict", methods = ["GET","POST"])
# def predict():
#     float_features = [float(x) for x in request.form.values()]
#     features = [np.array(float_features)]
...
#     if prediction==1:
#         return render_template("livercancer.html", prediction_text = "Chances of cancer")
#     else:
#         return render_template("livercancer.html", prediction_text = "No chances of cancer")
